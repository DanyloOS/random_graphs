...
// configuration step. It creates a namespace called `random_graphs`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", random_graphs::cmake::project_name, random_graphs::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", random_graphs::cmake::project_version);
      return EXIT_SUCCESS;
    }
